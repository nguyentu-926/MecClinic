            ...
            <div class="tat-input-panel">
                ...
                <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                       ...
                       @php
    // KHUNG GIỜ GỢI Ý (Nếu bạn đã truyền biến $appointmentSlots từ Controller, hãy sử dụng nó thay thế)
    $allSlots = $appointmentSlots ?? [
        '08:00-09:00',
        '09:30-10:30',
        '13:00-14:00',
        '14:30-15:30',
...
{{-- Giờ hẹn (Sử dụng Datalist để tạo gợi ý) --}}
<div class="mb-3">
    <label class="block mb-1 font-medium">Giờ hẹn</label>
    
    {{-- Input type="text" kết hợp với datalist --}}
    <input type="text" name="appointment_time" list="appointment-slots"
        class="form-control @error('appointment_time') border-red-500 @enderror" 
        value="{{ old('appointment_time', $appointment->appointment_time) }}" 
        placeholder="Chọn hoặc nhập giờ, ví dụ: 09:30-10:30"
        required>

    {{-- Datalist chứa danh sách khung giờ gợi ý --}}
