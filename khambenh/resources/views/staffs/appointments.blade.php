...
@section('content')
<div class="container">
    <h2 class="mb-4 text-center">👩‍💼 Quản lý lịch hẹn (Nhân viên)</h2>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="6" class="text-center text-muted">Không có lịch hẹn đã duyệt</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="6" class="text-center text-muted">Không có lịch chờ duyệt</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
