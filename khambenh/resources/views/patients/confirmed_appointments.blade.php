...
<div class="flex justify-start gap-4 mb-8">
    ...
    <h2 class="text-center text-xl font-semibold mb-4 text-green-700">✅ LỊCH HẸN ĐÃ DUYỆT</h2>

    @include('patients.partials.appointment_table', ['appointments' => $confirmedAppointments])
</div>
@endsection
