...
<div class="flex justify-start gap-4 mb-8">
    ...
    <h2 class="text-center text-xl font-semibold mb-4 text-yellow-600">⏳ LỊCH HẸN CHỜ DUYỆT</h2>

    @include('patients.partials.appointment_table', ['appointments' => $pendingAppointments])
</div>
@endsection
